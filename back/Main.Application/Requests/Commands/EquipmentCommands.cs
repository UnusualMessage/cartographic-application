...
public record CreateEquipment([Required] string Name, [Required] string Status, EquipmentFeature Feature,
...
([Required] Guid Id, [Required] string Name, [Required] string Status, EquipmentFeature Feature,
    [Required] Guid EquipmentTypeId, [Required] Guid OrganizationId, Guid? DepartmentId) : Request<EquipmentResponse>;
