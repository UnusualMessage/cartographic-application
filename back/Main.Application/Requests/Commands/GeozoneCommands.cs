...
public record CreateGeozone
    ([Required] string Title, [Required] Guid OrganizationId, Guid? DepartmentId) : Request<GeozoneResponse>;

public record UpdateGeozone
([Required] Guid Id, [Required] string Title, [Required] Guid OrganizationId,
